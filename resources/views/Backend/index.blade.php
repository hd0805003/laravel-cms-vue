...
@section('content')
<header class="Hui-header cl"><a class="Hui-logo l" title="laravelcms" href="/backend/index">laravelcms</a><span class="Hui-subtitle l">后台</span>
		...
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					...
					<li><a _href="{{ URL('backend/admin_list') }}" data-title="管理员列表" href="javascript:void(0)">管理员列表</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-tongji">
